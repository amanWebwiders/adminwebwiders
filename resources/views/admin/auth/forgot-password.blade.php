...
<body>
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            <h4 class="fw-bold m-0 mt-2">Password Reset</h4>
            <p class="text-white-50 small mt-1 mb-0">Enter your email to receive a password reset link</p>
        </div>
        ...
        <div class="login-body">
            ...
            <form method="POST" action="{{ route('admin.password.email') }}">
                ...
                <!-- Email Input -->
                <div class="mb-4">
                    <label for="email" class="form-label fw-semibold small text-secondary">Registered Email Address</label>
