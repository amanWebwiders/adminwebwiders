...
@section('page-header', 'Edit Blog Post')
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold m-0 text-dark">Edit Blog Information</h5>
                    <a href="{{ route('admin.blogs.show', $blog->id) }}" class="btn btn-sm btn-outline-info rounded-pill px-3">
                        <i class="fa-solid fa-eye me-1"></i> Preview Post
                    </a>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" id="editor" name="content">{{ old('content', $blog->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" rows="2">{{ old('meta_description', $blog->meta_description) }}</textarea>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            <option value="draft" {{ old('status', $blog->status) === 'draft' ? 'selected' : '' }}>Save as Draft</option>
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary py-2 fw-bold rounded-3">
                            <i class="fa-solid fa-floppy-disk me-2"></i> Update Blog Post
                        </button>
                    ...
                    <div class="mb-3 text-center">
                        @if($blog->featured_image_url)
                            <div id="currentImageContainer" class="mb-3">
                                ...
                                <img src="{{ $blog->featured_image_url }}" alt="Current Featured Image" class="img-fluid rounded border shadow-sm" style="max-height: 200px;">
                            </div>
                        @endif

                        <div id="imagePreviewContainer" class="mb-3 d-none">
                            <label class="d-block text-muted small mb-1">New Image Preview:</label>
                            <img id="imagePreview" src="#" alt="New Image Preview" class="img-fluid rounded border shadow-sm" style="max-height: 200px;">
                        </div>
